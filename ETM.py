...
if version[0] < 3:
    ...
    class thread(Thread):
        ...
        def run(self, connection:socket, serv_msg:int, client_ip:str):
            if serv_msg == 1:
                try:
    ...
    def verify_user_entry(expected_type:str, value, desired_value:array, input_text:str):
        value = value
        while True:
            try:
    ...
    def listener(socket:socket, pair_ip:str, key:RSA.RsaKey):
